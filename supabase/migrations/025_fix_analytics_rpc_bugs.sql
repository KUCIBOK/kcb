-- ============================================================================
-- Migration 025: Fix Analytics RPC SQL Bugs
-- ============================================================================
-- Fixes column ambiguity and missing FROM clause errors
-- ============================================================================

-- Fix: get_sales_volume_by_country - ambiguous 'currency' column
...
-- Fix: get_medium_performance - ambiguous 'medium' column
...
-- Fix: get_conversion_funnel - missing FROM-clause entry for table "fd"
...
-- ============================================================================
-- NOTES:
-- All functions now properly alias tables in FROM clauses
-- Column references are explicit with table prefixes
-- Functions still filter by date_filter - adjust manually for historical data
-- ============================================================================
