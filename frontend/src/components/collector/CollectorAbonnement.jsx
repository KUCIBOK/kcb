    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-400">Gérez votre plan et votre expérience de collectionneur</p>
        </div>
        {!subscription && (
          <Link
      ...
      {/* Current Plan Card */}
      <div className="bg-gradient-to-r from-purple-kcb/20 to-pink-kcb/20 rounded-xl p-6 border border-purple-kcb/30">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
