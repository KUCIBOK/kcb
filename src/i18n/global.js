export const globalT = {
  en: {
    ...
    logistics: {
      ...
      steps: [
        ...
        { num: "04", title: "Delivery", desc: "White-glove delivery to gallery, collector, or venue" },
      ],
    },
    sourcing: {
      label: "B2B Sourcing",
    ...
    simulator: {
      ...
      disclaimer: "Indicative estimate. Formal binding quote within 24h. Customs fees may vary depending on the exact customs classification of the artwork.",
    },
    footer: {
  ...
  fr: {
    ...
    hero: {
      ...
      titleAccent: "Circulation",
      subtitle: "Accédez à un catalogue sélectionné d'art africain contemporain certifié. Chaque pièce vérifiée. Chaque artiste documenté. Chaque expédition assurée.",
      cta1: "Parcourir le Catalogue",
      cta2: "Demander un Sourcing",
    },
    pillars: [
      { num: "01", title: "Certification KCB", text: "Identifiant unique, fiche de provenance, certificat d'authenticité. Vérifié par notre équipe d'experts." },
      { num: "02", title: "Logistique Porte-à-Porte", text: "Transport d'art spécialisé d'Afrique de l'Ouest vers l'Europe. Assurance, douanes, tracking temps réel." },
      { num: "03", title: "Sourcing B2B", text: "Accédez à notre réseau d'artistes africains vérifiés pour vos expositions, foires et collections privées." },
    ],
    catalogue: {
    ...
    logistics: {
      ...
      steps: [
        { num: "01", title: "Collecte", desc: "Enlèvement depuis l'atelier de l'artiste ou la galerie en Afrique de l'Ouest" },
        { num: "02", title: "Emballage Professionnel", desc: "Matériaux de qualité muséale, caisses sur mesure pour les grandes pièces" },
        { num: "03", title: "Douanes & Transit", desc: "Dédouanement export/import, transport assuré, tracking temps réel" },
        { num: "04", title: "Livraison", desc: "Livraison white-glove en galerie, chez le collectionneur ou sur le lieu d'exposition" },
      ],
    },
    sourcing: {
      label: "Sourcing B2B",
      ...
      features: [
        { title: "Sélection sur mesure", text: "Nous associons votre brief à des artistes de notre réseau certifié.", icon: "M10 2L12.5 7.5L18 8.5L14 12.5L15 18L10 15.5L5 18L6 12.5L2 8.5L7.5 7.5L10 2Z" },
        { title: "Documentation complète", text: "Fiches de provenance, certificats, portfolios d'artistes.", icon: "M14 2H6a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V4a2 2 0 00-2-2zM8 8h4M8 12h2" },
        { title: "Logistique de bout en bout", text: "De l'atelier à l'espace d'exposition. Emballage, transport, douanes.", icon: "M10 2a8 8 0 100 16 8 8 0 000-16zM2 10h16M10 2c2 2.5 3 5 3 8s-1 5.5-3 8c-2-2.5-3-5-3-8s1-5.5 3-8z" },
        { title: "Gestionnaire de compte dédié", text: "Interlocuteur unique. Maîtrise des deux marchés de l'art.", icon: "M10 10a8 8 0 100-16 8 8 0 000 16zM10 6v4l3 3" },
      ],
    },
    pricing: {
      label: "Tarifs",
    ...
    simulator: {
      ...
      disclaimer: "Estimation indicative. Cotation précise et contractuelle sous 24h. Les frais de douane peuvent varier selon la classification douanière exacte de l'œuvre.",
    },
    footer: {
