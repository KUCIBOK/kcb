export const globalT = {
  en: {
    ...
    pricing: {
      ...
      subtitle:
        'Four tiers designed for collectors, curators, and advisors. Every plan includes access to the certified catalogue.',
      plans: [
        {
          name: 'Découverte',
          desc: 'Explore the certified catalogue',
          price: 'Free',
          ...
          features: [
            ...
            'Basic shortlist (5 artists)',
          ],
          cta: { label: 'Get Started', to: '/sign-up' },
        },
        {
          name: 'Starter',
          desc: 'Market tools & Logidoo logistics',
          price: '27',
          priceSuffix: ' EUR',
          period: 'per month',
          features: [
            'Everything in Découverte',
            'Market Research Tools',
            'Logidoo logistics quotes',
            'Unlimited shortlist',
            'Priority support',
          ],
          cta: { label: 'Start Now', to: '/sign-up' },
        },
        {
          name: 'Premium',
          desc: 'Concierge services & budget tracking',
          price: '67',
          priceSuffix: ' EUR',
          period: 'per month',
          features: [
            'Everything in Starter',
            'Concierge services (1/month)',
            'Full budget tracker',
            'Priority logistics (Logidoo)',
            'Priority support 7d/7',
          ],
          featured: true,
          cta: { label: 'Go Premium', to: '/sign-up' },
        },
        {
          name: 'Institutional',
          desc: 'Galleries, museums, advisory firms',
          price: '147',
          priceSuffix: ' EUR',
          period: 'per month',
          features: [
  ...
  fr: {
    ...
    pricing: {
      ...
      subtitle:
        "Quatre niveaux conçus pour collectionneurs, curateurs et advisors. Chaque plan inclut l'accès au catalogue certifié.",
      plans: [
        {
          name: 'Découverte',
          desc: 'Explorez le catalogue certifié',
          price: 'Gratuit',
          ...
          features: [
            ...
            'Shortlist basique (5 artistes)',
          ],
          cta: { label: 'Commencer', to: '/sign-up' },
        },
        {
          name: 'Starter',
          desc: 'Outils marché & logistique Logidoo',
          price: '27',
          priceSuffix: ' EUR',
          period: 'par mois',
          features: [
            'Tout dans Découverte',
            'Market Research Tools',
            'Devis logistique Logidoo',
            'Shortlist illimitée',
            'Support prioritaire',
          ],
          cta: { label: 'Démarrer', to: '/sign-up' },
        },
        {
          name: 'Premium',
          desc: 'Services Concierge & suivi budget',
          price: '67',
          priceSuffix: ' EUR',
          period: 'par mois',
          features: [
            'Tout dans Starter',
            'Services Concierge (1/mois)',
            'Suivi budget complet',
            'Logistique Logidoo prioritaire',
            'Support 7j/7',
          ],
          featured: true,
          cta: { label: 'Passer Premium', to: '/sign-up' },
        },
        {
          name: 'Institutionnel',
          desc: 'Galeries, musées, cabinets advisory',
          price: '147',
          priceSuffix: ' EUR',
          period: 'par mois',
          features: [
            ...
            'Budget multi-projets',
            'Accès API complet',
            'Conseiller dédié Kucibok',
          ],
          cta: { label: 'Contacter', to: '/contact' },
        },
      ],
    },
    cta: {
