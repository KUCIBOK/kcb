...
const STEPS = [
  ...
  },
  {
    ...
    description: "Les artistes creent et soumettent leurs oeuvres d'art pour validation.",
    footer:
  ...
  },
  {
    ...
    description: "Decouvrez et achetez des oeuvres d'art africaines uniques.",
    footer:
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Toutes les réponses à vos questions sur Kucibok Bridge : certification d'œuvres, traçabilité, inscription artiste, livraison transfrontalière et paiements."
        />
        <meta
          property="og:title"
          content="FAQ Kucibok — Certification et marché de l'art africain"
        />
        <meta
          property="og:description"
          content="Questions fréquentes sur la certification, traçabilité, inscription et paiements sur Kucibok Bridge."
        />
          ...
          <div className="relative z-[1] max-w-[1280px] mx-auto px-[clamp(24px,5vw,80px)]">
            ...
            <RevealOnScroll delay={0.1}>
              <h1 className="font-playfair font-bold text-[clamp(32px,4vw,52px)] text-white mt-6 mb-5 leading-tight">
                Questions <em className="italic text-[var(--accent)]">frequentes</em>
              </h1>
            </RevealOnScroll>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0.5">
              {STEPS.map((step, i) => (
                <RevealOnScroll key={i} delay={Math.min(i, 3) * 0.1}>
                  <div className="bg-kcb-noir p-5 md:p-9 relative overflow-hidden group transition-transform duration-[400ms] ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-1 h-full flex flex-col">
                    ...
                    <div className="mt-auto pt-6 border-t border-white/[0.04]">
                      <p className="text-[11px] leading-[1.6] text-kcb-pierre/70">{step.footer}</p>
                    </div>
                  </div>
                </RevealOnScroll>
              ))}
          ...
          <div className="relative z-[1] max-w-[1280px] mx-auto px-[clamp(24px,5vw,80px)]">
            ...
            <RevealOnScroll delay={0.1}>
              <p className="text-[15px] text-kcb-pierre mb-12 max-w-[460px] mx-auto">
                Notre equipe est disponible pour vous accompagner. N'hesitez pas a nous contacter
                directement.
              </p>
            </RevealOnScroll>
            <RevealOnScroll delay={0.2}>
