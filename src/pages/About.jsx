  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Découvrez Kucibok Bridge — notre mission, nos valeurs et notre vision pour structurer et valoriser le marché de l'art africain à l'échelle mondiale."
        />
        <meta
          property="og:title"
          content="À propos de Kucibok — Infrastructure de l'art africain"
        />
        <meta
          property="og:description"
          content="Notre mission : structurer, certifier et faire circuler l'art africain en toute confiance."
        />
          ...
          <div className="relative z-[1] max-w-[1280px] mx-auto px-[clamp(24px,5vw,80px)]">
            ...
            <RevealOnScroll delay={0.1}>
              <h1 className="font-playfair font-bold text-[clamp(32px,4vw,52px)] text-white mt-6 mb-5 leading-tight">
                Renforcer la creativite <em className="italic text-[var(--accent)]">africaine</em>
              </h1>
            </RevealOnScroll>
            <RevealOnScroll delay={0.2}>
              <p className="text-[15px] text-kcb-pierre max-w-[540px] mx-auto leading-relaxed">
                Nous comblons le fosse entre les artistes africains et le marche mondial — grace a
                la blockchain, la certification et une infrastructure digitale de confiance.
              </p>
            </RevealOnScroll>
          </div>
        </section>
              ...
              <RevealOnScroll>
                <div>
                  ...
                  <p className="text-[13px] text-kcb-pierre leading-[1.8] mb-4">
                    KUCIBOK a ete fondee avec une vision claire : creer une plateforme dediee ou les
                    artistes africains peuvent presenter leur travail a un public mondial tout en
                    conservant la propriete et le controle de leurs actifs creatifs.
                  </p>
                  <p className="text-[13px] text-kcb-pierre leading-[1.8] mb-8">
                    L'art africain primitif est l'un des patrimoines les plus riches et les plus
                    fragiles de l'humanite. Des masques Dogon du Mali aux bronzes royaux du Benin,
                    ces oeuvres portent des siecles de culture, de spiritualite et d'histoire. Nous
                    construisons le gardien numerique de ce patrimoine.
                  </p>
                  <div className="space-y-3">
                    {VISION_POINTS.map((point, i) => (
                      <div key={i} className="flex items-start gap-3 text-[13px] text-kcb-sable">
              ...
              {VALUES.map((v, i) => (
                <RevealOnScroll key={i} delay={Math.min(i, 3) * 0.1}>
                  <div className="bg-kcb-noir p-5 md:p-9 lg:p-12 relative overflow-hidden group transition-transform duration-[400ms] ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-1">
                    ...
                    <p className="text-[13px] leading-[1.7] text-kcb-pierre">{v.description}</p>
                  </div>
                </RevealOnScroll>
              ))}
            </div>
          ...
          <div className="relative z-[1] max-w-[1280px] mx-auto px-[clamp(24px,5vw,80px)]">
            ...
            <RevealOnScroll delay={0.1}>
              <p className="text-[15px] text-kcb-pierre mb-12 max-w-[460px] mx-auto">
                Que vous soyez artiste, collectionneur ou passionne d'art africain, nous vous
                invitons a faire partie de notre communaute grandissante.
              </p>
            </RevealOnScroll>
            <RevealOnScroll delay={0.2}>
