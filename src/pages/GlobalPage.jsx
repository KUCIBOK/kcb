    ...
    <header className="sticky top-0 z-50 backdrop-blur-md bg-[#23243a]/90 border-b border-indigo-900/30 px-4 py-3">
      <div className="max-w-6xl mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-5 text-sm">
          ...
          <Link to="/global/services" className="text-gray-300 hover:text-indigo-400 transition-colors font-medium">
            Services
          </Link>
          <Link to="/global/logistics" className="text-gray-300 hover:text-indigo-400 transition-colors font-medium">
            Logistique
          </Link>
          <Link to="/global/enterprise" className="text-gray-300 hover:text-indigo-400 transition-colors font-medium">
            Entreprise
          </Link>
        </nav>
      ...
      {open && (
        <div className="md:hidden mt-3 border-t border-gray-800 pt-4 flex flex-col gap-4 pb-4">
          ...
          <Link to="/global/services" onClick={() => setOpen(false)} className="text-left text-gray-300 hover:text-indigo-400 transition-colors font-medium text-sm">
            Services
          </Link>
          <Link to="/global/logistics" onClick={() => setOpen(false)} className="text-left text-gray-300 hover:text-indigo-400 transition-colors font-medium text-sm">
            Logistique
          </Link>
          <Link to="/global/enterprise" onClick={() => setOpen(false)} className="text-left text-gray-300 hover:text-indigo-400 transition-colors font-medium text-sm">
            Entreprise
          </Link>
