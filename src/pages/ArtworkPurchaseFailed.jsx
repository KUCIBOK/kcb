        ...
        <div className="flex flex-col justify-center items-center px-4 py-10 max-w-lg mx-auto">
            ...
            <div className="w-full rounded-[4px] p-5 space-y-6 bg-kcb-noir-deep border border-white/[0.06]">
                ...
                <div className="bg-red-50 text-red-800 rounded-[4px] px-4 py-4">
                    <div className="font-playfair text-base font-medium mb-2">Raisons possibles de l'échec</div>
            ...
            <Link to={`/artwork-checkout/${state?.artwork?._id}`} className="rounded-md flex items-center justify-center w-full text-sm font-medium bg-kcb-or hover:bg-kcb-bronze transition py-2 px-4 mt-6">
                Réessayer le paiement
            </Link>
            <Link to={`/artwork/${state?.artwork?._id}`} className="rounded-md flex items-center justify-center w-full text-sm font-medium bg-kcb-noir-deep hover:bg-kcb-ardoise transition py-2 px-4 mt-2">
                Retour à l'œuvre
            </Link>
        </div>
        </RevealOnScroll>
