...
export default function ArtistDetails () {
    ...
    return (
        ...
        <div className="flex mx-auto flex-start lg:px-8 px-6 my-4">
            <Link to={-1} className="flex items-center gap-2 text-sm text-kcb-sable hover:text-white transition">
        ...
        <div className="flex flex-col md:px-8 px-4 lg:flex-row gap-8 w-full mx-auto -mt-20 z-10 relative mb-20 md:max-w-7xl">
            ...
            <div className="flex flex-col items-center max-h-fit bg-kcb-ardoise border border-white/[0.06] rounded-[4px] shadow-xl px-8 py-10 w-full lg:w-3/9">
                <div className="relative mb-3">
                    ...
                    <span className="absolute bottom-2 right-2 bg-kcb-ardoise/80 text-xs text-kcb-sable px-2 py-0.5 rounded-full shadow">{state.artist?.country}</span>
                </div>
                    ...
                    <div className="flex gap-3 mt-2">
                        {state.artist.socials.facebook && (
                            <a
                                ...
                                className="w-8 h-8 bg-kcb-ardoise hover:bg-blue-600 rounded-full flex items-center justify-center transition-colors duration-200"
                            >
                        ...
                        {state.artist.socials.instagram && (
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-8 h-8 bg-kcb-ardoise hover:bg-gradient-to-r hover:from-purple-500 hover:to-pink-500 rounded-full flex items-center justify-center transition-all duration-200"
                            >
                                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        {state.artist.socials.twitter && (
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-8 h-8 bg-kcb-ardoise hover:bg-blue-400 rounded-full flex items-center justify-center transition-colors duration-200"
                            >
                                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
