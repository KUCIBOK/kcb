                ...
                {!state?.loading ? (
                    ...
                    <div className="flex flex-col md:flex-row gap-8">
                        <div className="flex-1 border border-white/[0.06] rounded-[4px] p-6 flex flex-col shadow-md">
                            <h2 className="font-playfair text-xl text-white font-semibold mb-6">Résumé de votre abonnement</h2>
                            <h2 className="font-playfair text-xl text-white font-semibold text-center"> {state?.plan?.name} </h2>
