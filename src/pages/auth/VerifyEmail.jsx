    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-kcb-noir-deep px-4">
      <RevealOnScroll>
        <div className="w-full max-w-md bg-kcb-noir-deep border border-white/[0.06] rounded-[4px] shadow-xl p-8 flex flex-col items-center text-center">
          <h1 className="font-playfair text-[clamp(20px,2.5vw,28px)] font-bold text-white mb-4 tracking-tight">
          ...
          {state.error && (
            <>
              ...
              <p className="text-sm text-kcb-pierre mt-2">
                ...
                <br />
                Retournez à
                <a href="/sign-up" className="text-kcb-or font-medium hover:underline mx-1">
                  l’inscription
                </a>
                ou
                <a href="/sign-in" className="text-kcb-or font-medium hover:underline mx-1">
                  connectez-vous
                </a>
                .
              </p>
