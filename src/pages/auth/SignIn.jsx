        ...
        <RevealOnScroll>
          <div className="relative w-full max-w-sm mx-auto">
            <div className="text-center mb-10 mt-8">
              ...
              <h1 className="font-playfair text-xl font-semibold text-white mb-1 mt-4">
                Connexion
              </h1>
            ...
            <div className="border border-white/[0.06] bg-kcb-ardoise relative overflow-hidden">
              ...
              <div className="p-5 md:p-8">
                ...
                <form onSubmit={handleConnect} className="space-y-4" method="post">
                  ...
                  />
                  <div>
                    <label htmlFor="password" className="block text-sm font-medium text-kcb-sable">
                      Mot de passe
                    </label>
                  ...
                  <div className="flex justify-end">
                    <Link to="/forgot-password" className="text-xs text-kcb-or hover:underline">
                      Mot de passe oublié ?
                    </Link>
                  </div>
                  <Button
              ...
              <div className="flex items-center justify-center border-t border-white/[0.04] p-5">
                <p className="text-xs text-kcb-pierre">
                  Pas de compte ?{' '}
                  <Link to="/sign-up" className="font-semibold text-kcb-or hover:underline">
                    Inscription
                  </Link>
                </p>
              </div>
