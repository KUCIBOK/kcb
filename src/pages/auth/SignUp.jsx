  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      if (charge.role === 'artist' && !charge.image) {
        setFormState((p) => ({
          ...p,
          error: 'Photo de profil obligatoire pour les artistes.',
          loading: false,
        }))
        return
      }
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Créez votre compte Kucibok — artiste, collectionneur ou professionnel de l'art africain."
        />
      </Helmet>
            ...
            {STEP_LABELS.map((label, idx) => (
              <div key={idx} className="flex items-center">
                ...
                {idx < STEP_LABELS.length - 1 && (
                  <div
                    className={`w-8 h-px mx-1.5 mb-5 transition-all duration-500 ${
