  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Kucibok Bridge — Infrastructure SaaS de référence pour la certification, traçabilité et circulation sécurisée de l'art africain entre l'Afrique et le monde."
        />
        <meta property="og:title" content="Kucibok Bridge — Infrastructure de l'art africain" />
        <meta
          property="og:description"
          content="Kucibok Bridge — Infrastructure SaaS de référence pour la certification, traçabilité et circulation sécurisée de l'art africain."
        />
