...
export default function ArtworkPurchaseSuccess(){
    ...
    return (
        ...
        <div className="flex flex-col justify-center items-center px-4 py-10 max-w-lg mx-auto">
            ...
            <p className="text-gray-400 text-sm text-center mb-6">Félicitations ! Vous êtes maintenant propriétaire de cette œuvre d'art.</p></>) 
            : 
            (<>
            ...
            <div className="w-full rounded-xl p-5 space-y-6 bg-background border border-gray-800">
                ...
                <div className="bg-slate-900/90 rounded-lg px-4 py-4">
                    <div className="font-serif text-base font-medium mb-2 text-white">Informations importantes</div>
                    <ul className="list-disc px-4 text-xs text-gray-300">
                ...
                {state?.error && (
                    <div className="bg-red-50 text-red-800 font-medium rounded-lg px-4 py-4">
                        <div className="font-serif text-base mb-2">Erreur serveur</div>
                        <div>{state?.error}</div>
                    </div>
                )}
            </div>
            <div className="flex flex-col lg:flex-row gap-4 mt-6 w-full">
                <Link to={'/dashboard/collector'} className="rounded-md border border-gray-800 bg-background hover:bg-gray-900 transition flex items-center gap-2 px-4 py-2 w-full text-sm font-medium text-white justify-center">
                    <Eye className="w-4 h-4" /> Voir ma collection
                </Link>
                <Link to={'/explore'} className="rounded-md bg-gray-900 hover:bg-gray-800 transition flex items-center gap-2 px-4 py-2 w-full text-sm font-medium text-white justify-center">
