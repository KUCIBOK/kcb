      ...
      <section className="pt-40 pb-20 text-center px-6">
        ...
        <RevealOnScroll delay={0.1}>
          <h1 className="font-playfair text-4xl md:text-5xl font-bold text-white mt-6 mb-4">
            Conditions Générales de <em className="not-italic text-[var(--accent)]">Vente</em>
          </h1>
        </RevealOnScroll>
        <RevealOnScroll delay={0.2}>
          ...
          <p className="text-kcb-pierre text-[11px]">Dernière mise à jour : 28 juillet 2025</p>
        </RevealOnScroll>
      </section>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <RevealOnScroll>
            <article className="bg-kcb-noir border border-white/[0.06] p-8">
              ...
              <p className="text-kcb-sable text-[13px] leading-relaxed">
                Les présentes Conditions Générales de Vente (ci-après dénommées « CGV ») définissent
                les modalités d'acquisition d'œuvres d'art et de biens patrimoniaux sur Kucibok. En
                validant toute commande d'achat, vous reconnaissez avoir lu, compris et accepté sans
                réserve l'intégralité des dispositions contenues dans les présentes CGV. Cette
                acceptation est matérialisée par un processus de validation explicite lors de chaque
                transaction.
              </p>
            </article>
          </RevealOnScroll>
            ...
            <article className="bg-kcb-noir border border-white/[0.06] p-8">
              ...
              <div className="text-kcb-sable text-[13px] leading-relaxed">
                ...
                <div className="border border-[var(--accent)]/20 p-4">
                  <p>
                    <strong className="text-white">KUCIBOK SARL</strong>, Entreprise immatriculée au
                    registre du commerce et du crédit mobilier du Sénégal, sous le numéro [à
                    insérer, si disponible]. Ayant son siège social à : Liberté 6 Ext, Rue Ambassade
                    de France, Villa 24, Dakar, Sénégal.
                  </p>
                  <p className="mt-2">
                    Email de contact :{' '}
                    <a
                ...
                <p className="mt-3">
                  Nous nous engageons à vous fournir un environnement sûr et transparent pour toutes
                  vos transactions.
                </p>
              </div>
            </article>
          ...
          <RevealOnScroll>
            <article className="bg-kcb-noir border border-white/[0.06] p-8">
              ...
              <div className="text-kcb-sable text-[13px] leading-relaxed space-y-3">
                <p>
                  Ces CGV s'appliquent universellement à tous les acheteurs et collectionneurs,
                  quelle que soit leur localisation géographique.
                </p>
                <div className="border border-[var(--accent)]/20 p-4">
                  <h3 className="font-playfair font-semibold text-lg text-[var(--accent)] mb-2">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="border border-white/[0.06] p-4">
                    ...
                    <p className="text-[11px]">
                      Peintures, sculptures, photographies avec livraison par transporteurs
                      spécialisés
                    </p>
                  </div>
                  <div className="border border-white/[0.06] p-4">
                    ...
                    <p className="text-[11px]">
                      Créations digitales certifiées avec authentification Kucibok
                    </p>
                  </div>
                  <div className="border border-white/[0.06] p-4">
                    <h3 className="font-playfair font-semibold text-lg text-[var(--accent)] mb-2">
                    ...
                    <p className="text-[11px]">
                      Tokens numériques représentant la propriété sur blockchain
                    </p>
                  </div>
                  <div className="border border-white/[0.06] p-4">
                    <h3 className="font-playfair font-semibold text-lg text-[var(--accent)] mb-2">
                    ...
                    <p className="text-[11px]">
                      Objets historiques avec documentation et certifications
                    </p>
                  </div>
                </div>
                <p>
                  Chaque produit bénéficie d'une fiche descriptive détaillée incluant certificats de
                  numérisation et d'authenticité.
                </p>
              </div>
            </article>
          </RevealOnScroll>
              ...
              <div className="text-kcb-sable text-[13px] leading-relaxed space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <span className="bg-[var(--accent)] text-white text-xs rounded-full w-6 h-6 flex items-center justify-center font-bold flex-shrink-0 mt-0.5">
                      1
                    </span>
                    <div>
                      <strong className="text-white">Sélection de l'œuvre</strong>
                      <p className="text-[11px] mt-1">
                        Navigation, exploration des collections et ajout au panier
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] mt-1">
                        Récapitulatif détaillé avec frais annexes et taxes
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] mt-1">
                        Interface sécurisée pour la validation du paiement
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] mt-1">
                        Email de confirmation avec récapitulatif et numéro de commande
                      </p>
                    </div>
                  </div>
                </div>
                <div className="border border-[var(--accent)]/20 p-4">
                  <p className="text-kcb-sable text-[13px]">
                    <strong className="text-white">Droit d'annulation :</strong> Kucibok se réserve
                    le droit d'annuler toute commande en cas de suspicion de fraude,
                    d'indisponibilité de l'œuvre, ou de non-respect des conditions d'achat.
                  </p>
                </div>
              </div>
            </article>
          ...
          <RevealOnScroll>
            <article className="bg-kcb-noir border border-white/[0.06] p-8">
              ...
              <div className="text-kcb-sable text-[13px] leading-relaxed space-y-3">
                ...
                <div className="border border-[var(--accent)]/20 p-4">
                  <p className="text-kcb-sable text-[13px]">
                    <strong className="text-white">Ventes transfrontalières :</strong> L'acheteur
                    est responsable des droits de douane, taxes à l'importation et autres redevances
                    locales. Kucibok ne peut être tenue responsable de ces frais supplémentaires.
                  </p>
                </div>
              </div>
            </article>
          ...
          <RevealOnScroll>
            <article className="bg-kcb-noir border border-white/[0.06] p-8">
              ...
              <div className="text-kcb-sable text-[13px] leading-relaxed space-y-3">
                <div className="border border-white/[0.06] p-4">
                  <h3 className="font-playfair font-semibold text-lg text-[var(--accent)] mb-2">
                    Pour les consommateurs UE
                  </h3>
                  <p className="text-[11px]">
                    Délai de 14 jours calendaires à compter de la réception pour exercer votre droit
                    de rétractation, conformément à la Directive 2011/83/UE.
                  </p>
                </div>
                <div className="border border-white/[0.06] p-4">
                  <h3 className="font-playfair font-semibold text-lg text-[var(--accent)] mb-2">
              ...
              <div className="text-kcb-sable text-[13px] leading-relaxed space-y-4">
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="border border-white/[0.06] p-4">
                    ...
                    <p className="text-[11px]">
                      Garantie légale selon le Code de la consommation européen
                    </p>
                  </div>
                  <div className="border border-white/[0.06] p-4">
                    <h3 className="font-playfair font-semibold text-lg text-[var(--accent)] mb-2">
                    ...
                    <p className="text-[11px]">
                      Protection selon Code civil sénégalais et droit OHADA
                    </p>
                  </div>
                  <div className="border border-white/[0.06] p-4">
                    <h3 className="font-playfair font-semibold text-lg text-[var(--accent)] mb-2">
          ...
          <RevealOnScroll>
            <article className="bg-kcb-noir border border-white/[0.06] p-8">
              ...
              <div className="text-kcb-sable text-[13px] leading-relaxed space-y-3">
                <p>
                  Kucibok opère en tant que tiers de confiance et intermédiaire technique facilitant
                  la connexion entre vendeurs et acheteurs.
                </p>
                <div className="border border-white/[0.06] p-4">
                  <h3 className="font-playfair font-semibold text-lg text-[var(--accent)] mb-2">
                  ...
                  <p className="text-[11px]">
                    Limitée au bon fonctionnement de la plateforme et au respect du processus de
                    commande tel que décrit dans ces CGV.
                  </p>
                </div>
                <div className="border border-[var(--accent)]/20 p-4">
                  <p className="text-kcb-sable text-[13px]">
                    <strong className="text-white">Important :</strong> La responsabilité de la
                    conformité et de l'authenticité des œuvres incombe principalement au vendeur.
                    Kucibok facilite la résolution amiable des litiges.
                  </p>
                </div>
              </div>
            </article>
          ...
          <RevealOnScroll>
            <article className="bg-kcb-noir border border-white/[0.06] p-8">
              ...
              <div className="text-kcb-sable text-[13px] leading-relaxed space-y-3">
                <p>
                  La protection de vos données personnelles est une priorité absolue, en conformité
                  avec :
                </p>
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="border border-white/[0.06] p-3">
          ...
          <RevealOnScroll>
            <article className="bg-kcb-noir border border-white/[0.06] p-8">
              ...
              <div className="text-kcb-sable text-[13px] leading-relaxed space-y-3">
                <p>
                  Kucibok ne peut être tenue responsable en cas d'événements imprévisibles et
                  irrésistibles :
                </p>
                <div className="grid md:grid-cols-2 gap-3">
                  ...
                  <div className="border border-white/[0.06] p-3">
                    <strong className="text-[var(--accent)] text-[13px]">
                ...
                <p className="text-[11px]">
                  En cas de force majeure, nous vous informons rapidement et prenons toutes les
                  mesures raisonnables pour minimiser l'impact.
                </p>
              </div>
            </article>
          </RevealOnScroll>
                ...
                <div className="border border-white/[0.06] p-4">
                  ...
                  <div className="text-[11px] space-y-2">
                    ...
                    <div className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-[var(--accent)] rounded-full mt-2 flex-shrink-0" />
                      <span>
                        Juridictions du pays de résidence de l'acheteur (selon loi applicable)
                      </span>
                    </div>
                  </div>
                </div>
                <p className="text-[11px]">
                  Nous encourageons toujours le dialogue et la recherche de solutions amiables.
                </p>
              </div>
            </article>
          </RevealOnScroll>
            ...
            <article className="bg-kcb-noir border border-white/[0.06] p-8">
              ...
              <div className="border border-[var(--accent)]/20 p-4">
                <div className="text-kcb-sable text-[13px] space-y-2">
                  ...
                  <div>
                    Adresse : Liberté 6 Ext, Rue Ambassade de France, Villa 24, Dakar, Sénégal
                  </div>
                  <div>
                    Email général :{' '}
                    <a
                  ...
                  <div>
                    Téléphone :{' '}
                    <a
                      href="tel:+22176275018"
                      className="text-[var(--accent)] hover:opacity-80 transition-opacity"
                    >
                      +221 76 275 09 18
                    </a>
                  </div>
                  <div className="text-[11px] text-kcb-pierre">
                    Horaires : Lundi au vendredi, 9h-17h GMT
                  </div>
                </div>
              </div>
            </article>
          ...
          <RevealOnScroll>
            <article className="bg-kcb-noir border border-white/[0.06] p-8">
              ...
              <div className="text-kcb-sable text-[13px] leading-relaxed space-y-3">
                <p>
                  Toute contestation sera d'abord soumise à une tentative de résolution amiable.
                  Nous encourageons nos utilisateurs à nous contacter directement pour exprimer
                  leurs préoccupations.
                </p>
                <div className="border border-white/[0.06] p-4">
                  <p className="text-kcb-sable text-[13px]">
                    Les parties s'engagent à privilégier la médiation ou tout autre mode alternatif
                    de règlement des litiges avant toute action judiciaire.
                  </p>
                </div>
              </div>
            </article>
