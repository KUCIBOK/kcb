        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mt-8 bg-kcb-or/5 border border-kcb-or/20 rounded-[4px] p-4">
            <p className="text-kcb-or text-sm">
              <strong>Besoin d'aide ?</strong> Si le problème persiste, vérifiez vos informations de
              paiement ou contactez notre équipe de support. Aucun montant n'a été débité de votre
              compte.
            </p>
          </div>
        </div>
