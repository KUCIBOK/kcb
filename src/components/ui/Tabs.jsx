...
const variants = {
  line: {
    ...
    active:
      'text-kcb-or after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0.5 after:bg-kcb-or',
...
export function Tabs({
  ...
  return (
    <div className={className}>
      ...
      <div
        role="tablist"
        className={`flex ${fullWidth ? 'w-full' : ''} ${variantStyles.container}`}
      >
        {tabs.map((tab, index) => {
