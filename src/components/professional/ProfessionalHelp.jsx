...
export function ProfessionalHelp() {
  const faqItems = [
    ...
    },
    {
      ...
      content: (
        <div className="space-y-2 text-sm text-kcb-pierre">
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>
              <strong>Galerie</strong>: Espace d'exposition
            </li>
            <li>
              <strong>Studio</strong>: Atelier d'artiste
            </li>
            <li>
              <strong>Collectif</strong>: Groupe d'artistes
            </li>
            <li>
              <strong>Marketplace</strong>: Plateforme de vente
            </li>
          </ul>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-2 text-sm text-kcb-pierre">
          <p>
            <strong>Métriques principales:</strong>
          </p>
          <ul className="list-disc list-inside space-y-1">
            <li>
              <strong>Chiffre d'affaires</strong>: Total des ventes mensuelles
            </li>
            <li>
              <strong>Ventes par artiste</strong>: Performance de chaque artiste
            </li>
            <li>
              <strong>Taux de conversion</strong>: % de visiteurs convertis en acheteurs
            </li>
            <li>
              <strong>Temps moyen de vente</strong>: Délai avant achat
            </li>
          </ul>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="space-y-2 text-sm text-kcb-pierre">
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>
              <strong>Email</strong>: Campagnes newsletters
            </li>
            <li>
              <strong>Calendrier</strong>: Événements et expositions
            </li>
            <li>
              <strong>Réseaux sociaux</strong>: Partage automatique
            </li>
            <li>
              <strong>Webhooks</strong>: Intégrations personnalisées
            </li>
          </ul>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="space-y-2 text-sm text-kcb-pierre">
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>
              Créer des <strong>listes statiques</strong> manuelles
            </li>
            <li>
              Configurer des <strong>listes dynamiques</strong> (critères auto)
            </li>
  ...
  return (
    <div className="bg-kcb-ardoise rounded-[4px] shadow-md border border-white/[0.06] p-6">
      ...
      <Accordion items={faqItems} defaultValue="crm" variant="line" className="space-y-2" />

      <div className="mt-8 p-4 bg-kcb-or/10 border border-kcb-or/20 rounded-[4px]">
        <p className="text-sm text-kcb-sable">
          💡 <strong>Besoin d'aide supplémentaire?</strong> Contactez notre équipe support à
          support@kucibok.com
        </p>
      </div>
    </div>
