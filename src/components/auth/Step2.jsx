...
const INPUT = "w-full border border-white/[0.08] bg-kcb-noir px-3 py-3 pr-10 text-sm text-white placeholder-kcb-pierre/50 focus:outline-none focus:ring-1 focus:ring-kcb-or focus:border-kcb-or transition-all duration-200";
  ...
  return (
    <div className="bg-kcb-ardoise border border-white/[0.06] p-8 relative overflow-hidden">
      ...
      >
        ...
        <div>
          ...
          {formState.password && (
            <div className="mt-2">
              ...
              <p className={`text-[10px] ${strength <= 1 ? "text-red-400" : strength <= 2 ? "text-yellow-400" : "text-green-400"}`}>
        ...
        {/* Confirm password */}
        <div>
          <label htmlFor="confirmPassword" className="block text-xs font-medium text-kcb-sable mb-1.5">
          ...
          {mismatch && (
            <p className="text-[11px] text-red-400 mt-1.5">Les mots de passe ne correspondent pas</p>
          )}
