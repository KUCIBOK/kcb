...
export function ChangePassword(){
    ...
    return (
        <>
            <button onClick={() => setState(true)} className="px-4 py-2 text-white text-sm my-4 rounded-md flex justify-center items-center gap-2 bg-background mx-auto hover:bg-background/80">
