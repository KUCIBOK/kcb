    ...
    <div className="bg-kcb-ardoise border border-white/[0.06] relative overflow-hidden">
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-kcb-pierre">
              Aidez-nous à vous recommander les œuvres qui correspondent à vos goûts. Modifiable
              depuis votre profil.
            </p>
          </div>
      ...
      <div className="p-8 space-y-5">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label htmlFor="s5c-username" className={LABEL}>
              Pseudo
            </label>
            <input
              id="s5c-username"
          ...
          <div>
            <label htmlFor="s5c-tel" className={LABEL}>
              Téléphone
            </label>
            <input
              id="s5c-tel"
        ...
        <div>
          <label className={LABEL}>
            ...
            {selected.length > 0 && (
              <span className="ml-2 text-kcb-or font-normal">
