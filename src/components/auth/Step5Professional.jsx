/**
 * Step5Professional — Enrichissement profil professionnel (optionnel, skippable).
 */
...
export const Step5Professional = ({ formState, setFormState, onEnrich, onSkip }) => {
    ...
    <div className="bg-kcb-ardoise border border-white/[0.06] relative overflow-hidden">
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-kcb-pierre">
              Détaillez votre activité pour accéder aux outils B2B adaptés. Modifiable depuis votre profil.
            </p>
          </div>
      ...
      <div className="p-8 space-y-5">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label htmlFor="s5p-username" className={LABEL}>Pseudo</label>
            <input id="s5p-username" type="text" minLength={3}
          ...
          <div>
            <label htmlFor="s5p-tel" className={LABEL}>Téléphone</label>
            <input id="s5p-tel" type="tel"
        ...
        {/* Qualifications */}
        <div>
          <label htmlFor="s5p-qualif" className={LABEL}>Expérience & qualifications</label>
          <textarea id="s5p-qualif" rows={3}
