    ...
    <div className="bg-kcb-ardoise border border-white/[0.06] relative overflow-hidden">
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-kcb-pierre">
              Ces informations aident les collectionneurs à vous découvrir. Vous pouvez les ajouter maintenant ou plus tard depuis votre dashboard.
            </p>
          </div>
      ...
      <div className="p-8 space-y-5">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label htmlFor="s5-username" className={LABEL}>Pseudo</label>
            <input id="s5-username" type="text" minLength={3}
          ...
          <div>
            <label htmlFor="s5-tel" className={LABEL}>Téléphone</label>
            <input id="s5-tel" type="tel"
        ...
        {/* Biographie */}
        <div>
          <label htmlFor="s5-bio" className={LABEL}>Biographie</label>
          <textarea id="s5-bio" rows={3}
