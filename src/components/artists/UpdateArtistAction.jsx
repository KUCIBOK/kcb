  ...
  return (
    <>
      ...
      {state?.updateArtist && (
        <Modal
          artist={artist}
          closeModal={() => setState({ ...state, updateArtist: false })}
        />
      )}
    </>
  );
        ...
        <div className="rounded-[4px] border border-border bg-kcb-noir h-7/9 py-6 px-4 w-13/15 xl:w-4/9 animate-scale-up overflow-auto">
          ...
          >
            ...
            <div className="">
              <label
                htmlFor="biography"
                className="font-serif text-white font-medium text-lg"
              >
                Biographie
              </label>
              <ReactQuill
            ...
            <div className="">
              ...
              <input
                onChange={(e) =>
                  setState({ ...state, portfolio: e.target.value })
                }
            ...
            <div className="flex items-center justify-end gap-4">
              ...
              <button
                type="submit"
                className="rounded-md px-4 py-2.5 bg-green-600"
              >
