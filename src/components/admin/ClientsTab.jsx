    ...
    <div>
      ...
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h2 className="text-2xl font-bold text-white">Portefeuille clients</h2>
        </div>
        <p className="text-kcb-pierre">Tous les clients de tous les artistes de la plateforme</p>
      </div>

      {/* Stats */}
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-kcb-noir border border-white/[0.06] rounded-[4px] p-4">
          <div className="text-2xl font-bold text-white mb-1">{clients.length}</div>
        ...
        {currentSet?.length >= 1 ? (
          ...
          <div className="text-center py-16 border border-white/[0.06] border-dashed rounded-[4px] w-full bg-white/[0.04]">
            ...
            <p className="text-sm text-kcb-pierre">
              {search ? 'Essayez une autre recherche' : "Aucun client n'a encore été ajouté"}
            </p>
          </div>
        )}
      </div>
