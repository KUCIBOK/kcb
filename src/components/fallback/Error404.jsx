        ...
        <div className="p-6 sm:p-10">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-kcb-pierre mb-8">
              Oups ! On dirait que vous vous aventurez en territoire inconnu. La page que vous
              recherchez n'existe pas dans la galerie{' '}
              <span className="font-semibold text-kcb-ivoire">Kucibok</span>.
            </p>
