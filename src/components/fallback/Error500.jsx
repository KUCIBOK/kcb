                ...
                <div className="p-6 sm:p-10">
                    <div className="flex flex-col items-center text-center">
                        ...
                        <p className="text-kcb-pierre mb-8">
                            Oups ! On dirait que quelque chose a mal tourné en coulisses.
                            Veuillez réessayer ou contacter l'administrateur si le problème persiste.
                            La galerie <span className="font-semibold text-kcb-ivoire">Kucibok</span> est toujours là pour vous.
                        </p>
