    ...
    >
      ...
      >
        ...
        <ellipse
          ...
          rx="14"
          ry="5"
          fill="rgba(90,130,210,0.06)"
          stroke="rgba(110,155,230,0.12)"
          strokeWidth="0.5"
        />
        ...
        <g transform="translate(18, 418)">
          <rect x="-4" y="-8" width="178" height="60" rx="2" fill="rgba(5,12,24,0.75)" />
          {/* Row 1 */}
          <line
            x1="0"
            y1="0"
