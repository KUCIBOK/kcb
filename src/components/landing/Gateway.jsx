    ...
    <div className="fixed inset-0 z-[200] flex flex-col md:flex-row font-dm-sans">
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage:
              'repeating-linear-gradient(90deg, #C9A84C 0px, #C9A84C 1px, transparent 1px, transparent 100px)',
          }}
        />
        {/* Radial glow */}
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 60% 50% at 50% 30%, rgba(201,168,76,0.06), transparent 70%)',
          }}
        />
        ...
        <div className="relative z-[2] text-center max-w-[420px] w-full flex flex-col items-center">
          ...
          <h2 className="font-playfair font-bold text-[clamp(18px,3.5vw,40px)] leading-[1.1] mb-2 md:mb-4">
            Votre art merite
            <br />
            un standard <em className="italic text-kcb-or">mondial</em>
          </h2>
          <p className="hidden sm:block text-[12px] md:text-[13px] font-light leading-[1.7] text-kcb-pierre mb-5 md:mb-9 max-w-[340px]">
            Certification gratuite, logistique specialisee, visibilite internationale. Pour les
            artistes d'Afrique de l'Ouest.
          </p>
          <button
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage:
              'repeating-linear-gradient(90deg, #A8B0BC 0px, #A8B0BC 1px, transparent 1px, transparent 100px)',
          }}
        />
        {/* Radial glow */}
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 60% 50% at 50% 30%, rgba(168,176,188,0.05), transparent 70%)',
          }}
        />
        ...
        <div className="relative z-[2] text-center max-w-[420px] w-full flex flex-col items-center">
          ...
          <h2 className="font-playfair font-bold text-[clamp(18px,3.5vw,40px)] leading-[1.1] mb-2 md:mb-4">
            The Standard for
            <br />
            African Art <em className="italic text-kcb-silver-light">Circulation</em>
          </h2>
          <p className="hidden sm:block text-[12px] md:text-[13px] font-light leading-[1.7] text-kcb-pierre mb-5 md:mb-9 max-w-[340px]">
            Curated catalogue, certified artworks, door-to-door logistics. For collectors and
      ...
      <div
        className="absolute left-0 right-0 md:hidden z-10 pointer-events-none"
        style={{ top: '50%', height: '1px', background: 'rgba(255,255,255,0.06)' }}
      />
