...
const STATUS_CFG = {
  certified: {
    label: 'Certifié',
    cls: 'bg-emerald-950/60 text-emerald-400 border border-emerald-800/40',
  },
  transit: { label: 'En transit', cls: 'bg-blue-950/60 text-blue-400 border border-blue-800/40' },
  pending: {
    label: 'En attente',
    cls: 'bg-amber-950/60 text-amber-400 border border-amber-800/40',
  },
}
    ...
    <div className="flex-1 p-6 min-w-0">
      ...
      <div className="mt-6">
        <div className="flex items-center justify-between mb-2">
          ...
          <span
            className="font-jetbrains text-[9px] cursor-default"
          ...
          return (
            <div
              ...
              className={[
                ...
                i < ARTWORKS.length - 1 ? 'border-b border-kcb-silver/[0.05]' : '',
              ].join(' ')}
            >
              <div
              ...
              <div className="min-w-0">
                <p className="font-dm-sans text-[12px] text-white leading-tight truncate">
                  {aw.title}
                </p>
              ...
              <span
                className={`font-jetbrains text-[8px] tracking-[0.06em] px-2 py-0.5 rounded-[2px] whitespace-nowrap ${s.cls}`}
              >
                {s.label}
              </span>
              <span className="font-jetbrains text-[9px] text-kcb-pierre/40 w-12 text-right flex-shrink-0">
                {aw.date}
              </span>
            </div>
          )
...
const CLIENTS = [
  {
    ...
    total: '€4 200',
    tag: 'Actif',
    tagCls: 'bg-emerald-950/60 text-emerald-400 border border-emerald-800/40',
    color: '#1a2030',
  },
  {
    initials: 'JA',
  ...
  },
  {
    ...
    total: '€1 400',
    tag: 'Prospect',
    tagCls: 'bg-amber-950/60 text-amber-400 border border-amber-800/40',
    color: '#201a10',
  },
  {
    initials: 'PD',
    ...
    <div className="flex-1 p-6 min-w-0">
      ...
      <div className="grid grid-cols-3 gap-3 mb-5">
        {[
          ...
          <div
            key={s.label}
            className="p-3 rounded-sm border border-kcb-silver/[0.08]"
            style={{ background: 'rgba(44,52,66,0.6)' }}
          >
            <p className="font-playfair font-bold text-lg text-white leading-none">{s.num}</p>
            <p className="font-jetbrains text-[8px] tracking-[0.1em] uppercase text-kcb-pierre mt-1">
              {s.label}
            </p>
            <p className="font-dm-sans text-[9px] mt-1" style={{ color: s.color }}>
              {s.sub}
            </p>
          </div>
        ))}
      ...
      {CLIENTS.map((c, i) => (
        <div
          ...
          className={[
            'flex items-center gap-3 py-2.5',
            i < CLIENTS.length - 1 ? 'border-b border-kcb-silver/[0.05]' : '',
          ].join(' ')}
        >
          {/* Avatar */}
          <div
            className="w-8 h-8 flex-shrink-0 rounded-full flex items-center justify-center font-dm-sans text-[9px] font-bold text-black"
          ...
          <div className="text-right mr-3">
            ...
            <p className="font-jetbrains text-[8px] text-kcb-pierre/40 mt-0.5">
              {c.works} œuvre{c.works > 1 ? 's' : ''}
            </p>
          </div>
          {/* Status */}
          <span
            className={`font-jetbrains text-[8px] tracking-[0.06em] px-2 py-0.5 rounded-[2px] whitespace-nowrap ${c.tagCls}`}
          >
            {c.tag}
          </span>
        </div>
...
const TRANSACTIONS = [
  {
    label: 'Harmattan Series #3',
    buyer: 'Marie Lefèvre · Paris',
    amount: '+€1 400',
    date: '14 mar.',
    status: 'credited',
  ...
  {
    label: 'Marché de Dakar',
    buyer: 'Pierre Dubois · Genève',
    amount: '+€2 100',
    date: '10 mar.',
    status: 'credited',
    statusCls: 'text-emerald-400',
  ...
  {
    label: 'Portrait III',
    buyer: 'James Adeyemi · London',
    amount: '+€700',
    date: '07 mar.',
    status: 'en cours',
    statusCls: 'text-amber-400',
  },
]
  ...
  return (
    <div className="flex-1 p-6 min-w-0">
      ...
      >
        <div>
          <p
            className="font-jetbrains text-[8px] tracking-[0.15em] uppercase mb-1"
            ...
            <div className="flex flex-col items-center">
                ...
                style={{
                  ...
                  border: step.active
                    ...
                    : step.done
                      ...
                      : '1px solid rgba(168,176,188,0.12)',
                }}
              >
                {step.done && !step.active && (
                  <svg width="6" height="5" viewBox="0 0 6 5" fill="none">
                    <path
                      d="M.5 2.5l1.5 1.5 3-3"
                      stroke="#34d399"
                      strokeWidth="1.2"
                      strokeLinecap="round"
              ...
              {i < PAY_STEPS.length - 1 && (
                <div
                  ...
                  style={{ background: 'rgba(201,168,76,0.15)', minHeight: '28px' }}
                />
              )}
            </div>
            <div className="pb-0 min-w-0">
              <p
                className={`font-dm-sans text-[10px] leading-tight ${step.active ? 'text-white' : 'text-white/60'}`}
              >
                {step.label}
              </p>
      ...
      {TRANSACTIONS.map((tx, i) => (
        <div
          ...
          className={[
            ...
            i < TRANSACTIONS.length - 1 ? 'border-b border-kcb-silver/[0.05]' : '',
          ].join(' ')}
        >
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        ...
        <RevealOnScroll className="mb-12">
          <div className="max-w-2xl">
            ...
            <p className="font-dm-sans text-kcb-pierre text-[15px] leading-relaxed">{ft.desc}</p>
          </div>
        </RevealOnScroll>
        ...
        <RevealOnScroll delay={0.1}>
          ...
          >
            {/* Top bar */}
            <div
              className="flex items-center gap-3 px-4 py-3 border-b border-kcb-silver/[0.07]"
            ...
            >
              <div
                ...
                style={{ background: 'var(--accent)' }}
              >
                <span className="font-jetbrains text-[7px] font-bold text-black leading-none">
                  K
                </span>
              </div>
              <span className="font-jetbrains text-[10px] tracking-[0.08em] text-white/70">
                Kucibok Bridge
              </span>
              ...
              <span className="font-jetbrains text-[9px] text-kcb-pierre/70 mr-2">
                Ibrahim Maïga
              </span>
              <div
                className="w-6 h-6 rounded-full flex items-center justify-center text-[8px] font-bold text-black font-dm-sans"
                style={{ background: 'var(--accent)' }}
              >
                IM
              </div>
            ...
            <div className="flex" style={{ minHeight: '260px' }}>
              ...
              <div
                className="hidden sm:block flex-shrink-0 border-r border-kcb-silver/[0.06] pt-5"
                style={{ width: '160px', background: '#0b0e14' }}
              >
          ...
          {FEATURES.map((f, i) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className="font-jetbrains text-[10px] tracking-[0.15em]"
                  style={{ color: isActive ? 'var(--accent)' : 'rgba(201,168,76,0.4)' }}
                >
                  {f.num}
                </span>
                <p
                  className={`font-dm-sans font-semibold text-sm mt-3 mb-2 transition-colors duration-300 ${isActive ? 'text-white' : 'text-white/50'}`}
                >
                  {f.title}
                </p>
                <p
                  className={`font-dm-sans text-xs leading-relaxed transition-colors duration-300 ${isActive ? 'text-kcb-pierre' : 'text-kcb-pierre/40'}`}
                >
                  {f.desc}
                </p>
              </button>
