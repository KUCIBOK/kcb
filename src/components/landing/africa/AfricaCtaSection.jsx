      ...
      <div className="relative z-[1] max-w-[1280px] mx-auto px-[clamp(24px,5vw,80px)]">
        ...
        <RevealOnScroll delay={0.2}>
          <div className="flex justify-center gap-4 flex-wrap">
            ...
            <Link to="/africa/about" className="inline-flex items-center gap-2 bg-transparent text-[var(--accent)] font-dm-sans font-semibold text-xs tracking-[0.08em] uppercase px-9 py-3.5 border border-[var(--accent)] transition-all hover:bg-[var(--accent)] hover:text-kcb-noir no-underline">
              {t.secondary}
            </Link>
          </div>
        </RevealOnScroll>
