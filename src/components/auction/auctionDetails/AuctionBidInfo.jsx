...
export default function AuctionBidInfo({ currentPrice, endTime, winner, bidCount }) {
  return (
    <div className="bg-kcb-ardoise/50 p-4 rounded-[4px] border border-white/[0.06]/50">
      <div className="mb-4">
        <p className="text-kcb-pierre text-sm">Prix actuel</p>
        <p className="text-2xl font-bold text-white">{currentPrice} FCFA</p>
      </div>

      <div className="mb-4">
        <p className="text-kcb-pierre text-sm">Temps restant</p>
        <div className="flex items-center">
          <Clock className="w-4 h-4 mr-1 text-kcb-pierre" />
      ...
      <div>
        <p className="text-kcb-pierre text-sm">Nombre d'enchères</p>
