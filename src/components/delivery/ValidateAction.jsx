...
export function ValidateAction({delivery}){
    ...
    return (
        ...
        <button 
            ...
            onClick={() => setModal(true)} className="text-green-500 hover:text-green-700 p-2 rounded-md bg-green-600 hover:bg-green-700 shadow-sm transition-colors">
...
function ValidateModal({delivery, closeModal}){
    ...
    const handleValidation = async (e) => {
        ...
        try {
            ...
            const response = await changeStatus(delivery._id, {status : state.status, price: state.price, trackingId : state.trackingId});
