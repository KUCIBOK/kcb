...
export function RejectAction({delivery}){
    ...
    return (
        ...
        <button 
            ...
            onClick={() => setModal(true)} className="text-white p-2 rounded-md bg-red-800 hover:bg-red-900 shadow-sm transition-colors">
...
function RejectModal({delivery, closeModal}){
    ...
    const handleValidation = async (e) => {
        ...
        try {
            ...
            const response = await changeStatus(delivery._id, {status : state.status, reason : state.reason});
