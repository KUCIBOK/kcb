...
export const Step2 = memo(function Step2({ formState, setFormState }) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <label htmlFor="image" className="text-sm text-white font-semibold mb-2 block">
          Image
        </label>
        <div className="bg-kcb-ardoise border-2 border-white/[0.06] border-dashed rounded-[4px] p-8 text-center transition-all">
          {formState.image ? (
            <div className="space-y-4 animate-fade-in-up">
              ...
              <button
                type="button"
                className="px-4 py-2 text-sm text-white font-medium rounded-[4px] border border-white/[0.06] bg-kcb-ardoise hover:bg-kcb-ardoise transition"
                onClick={() => setFormState({ ...formState, image: null, show: '' })}
              >
                Changer l'image
              </button>
            </div>
            ...
            <div className="space-y-4">
              <div
                ...
                className="flex flex-col items-center justify-center py-6 cursor-pointer group focus-visible:ring-2 focus-visible:ring-kcb-or rounded-[4px] outline-none"
              >
                ...
                <p className="text-sm text-kcb-pierre group-hover:text-white transition-colors">
                  Glissez-déposez l'image ici, ou <span className="underline">cliquez</span> pour
