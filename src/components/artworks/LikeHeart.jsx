  ...
  return (
    <>
      ...
      <div className="absolute top-3 right-3 flex items-center gap-1 bg-kcb-noir/70 rounded-full px-2 py-1">
        <button onClick={handleLike} className="p-1 rounded-full hover:scale-110 transition">
          <Heart
            className={`w-5 h-5 ${state?.isLiked ? 'fill-red-500 stroke-red-500' : 'stroke-white'}`}
          />
        </button>
