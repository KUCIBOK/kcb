    ...
    <>
      <section className="border border-white/[0.06] rounded-[4px] p-6">
        <header className="flex items-center gap-2 mb-6">
          <span className="inline-flex items-center justify-center bg-kcb-or/10 rounded-full p-2">
            <Scan className="w-5 h-5 text-kcb-or" />
          </span>
        ...
        <form className="space-y-5" onSubmit={handleSubmit} autoComplete="off">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div>
              <label htmlFor="artworks" className="block text-xs text-kcb-pierre mb-1">
                Type d'oeuvres à numériser
              </label>
              <select
                id="category"
            ...
            <div>
              <label htmlFor="artworkCount" className="block text-xs text-kcb-pierre mb-1">
                Nombre d'œuvres
              </label>
              <input
                type="number"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label htmlFor="address" className="block text-xs text-kcb-pierre mb-1">
                Adresse
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="telephone" className="block text-xs text-kcb-pierre mb-1">
                Numéro de téléphone
              </label>
              <input
                type="tel"
          ...
          <div>
            <label htmlFor="description" className="block text-xs text-kcb-pierre mb-1">
              Description
            </label>
            <textarea
              id="description"
          ...
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-2 rounded-[4px] bg-kcb-or hover:bg-kcb-or/90 text-kcb-noir font-semibold py-2 transition-all text-sm"
            disabled={state.loading}
          >
            {!state.loading ? (
              <>
                <Scan className="w-4 h-4" /> Créer la demande
              </>
            ) : (
              <DataLoader />
            )}
