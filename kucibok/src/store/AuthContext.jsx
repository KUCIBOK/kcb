...
export function AuthContextProvider({ children }) {
  ...
  // ── Chargement du profil étendu (backend MongoDB — sera migré M2) ──────────
  ...
  /** Met à jour les données utilisateur via le backend MongoDB (M2 → Supabase). */
  ...
  /** Change le mot de passe via le backend MongoDB (M2 → supabase.auth.updateUser). */
